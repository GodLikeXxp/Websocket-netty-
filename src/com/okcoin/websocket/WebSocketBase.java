...
public abstract class WebSocketBase {
	...
	public void addChannel(String channel) {
		...
		this.sendMessage("{'event':'addChannel','channel':'ok_sub_spot_ltc_btc_ticker','binary':'true'}");
		this.sendMessage("{'event':'addChannel','channel':'ok_sub_spot_X_depth','binary':'true'}");
		this.sendMessage("{'event':'addChannel','channel':'ok_sub_spot_X_depth_Y'}");
		this.sendMessage("{'event':'addChannel','channel':'ok_sub_spot_X_deals'}");
		this.sendMessage("{'event':'addChannel','channel':'ok_sub_spot_X_kline_Y'}");
	...
	public void getUserInfo(String apiKey, String secretKey) {
		...
		log.info(tradeStr.toString());
		this.sendMessage(tradeStr.toString());
		//System.err.println("订阅交易数据");
		//this.sendMessage("{'event':'addChannel','channel':'ok_sub_spot_bch_btc_deals'}");
	}
