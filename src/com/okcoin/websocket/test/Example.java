...
public class Example {
	public static void main(String[] args) {
		...
		apiKey = "398b9df8-cdcc-4543-b8be-d1279b79b766";
		secretKey = "E022333DD6EFD79A5606B0E8B1F3D6F2";
		
		// 国际站WebSocket地址 注意如果访问国内站 请将 real.okcoin.com 改为 real.okcoin.cn
		String url = "wss://real.okcoin.com:10440/websocket/okcoinapi";
		url="wss://real.okcoin.com:10441/websocket";
		...
		// 添加订阅
		//this.sendMessage("{'event':'addChannel','channel':'ok_sub_spot_bch_btc_ticker'}");
		//client.addChannel("ok_sub_spotusd_btc_ticker");
		client.addChannel("ok_sub_spot_bch_btc_ticker");
